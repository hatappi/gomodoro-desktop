...
export type PomodoroDetailsFragment = {
  __typename?: "Pomodoro";
  id: string;
  state: PomodoroState;
  taskId: string;
...
export type CurrentPomodoroQuery = {
  __typename?: "Query";
  currentPomodoro?: {
    __typename?: "Pomodoro";
    id: string;
...
export type StartPomodoroMutation = {
  __typename?: "Mutation";
  startPomodoro?: {
    __typename?: "Pomodoro";
    id: string;
...
export type PausePomodoroMutation = {
  __typename?: "Mutation";
  pausePomodoro?: {
    __typename?: "Pomodoro";
    id: string;
...
export type ResumePomodoroMutation = {
  __typename?: "Mutation";
  resumePomodoro?: {
    __typename?: "Pomodoro";
    id: string;
...
export type StopPomodoroMutation = {
  __typename?: "Mutation";
  stopPomodoro?: {
    __typename?: "Pomodoro";
    id: string;
...
export type OnPomodoroEventSubscription = {
  __typename?: "Subscription";
  eventReceived: {
    __typename?: "Event";
    eventCategory: EventCategory;
...
export const PomodoroDetailsFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: "Field", name: { kind: "Name", value: "phaseCount" } },
          { kind: "Field", name: { kind: "Name", value: "phaseDurationSec" } },
          { kind: "Field", name: { kind: "Name", value: "remainingTimeSec" } },
          { kind: "Field", name: { kind: "Name", value: "elapsedTimeSec" } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<PomodoroDetailsFragment, unknown>;
...
export const CurrentPomodoroDocument = {
  kind: "Document",
  definitions: [
    {
...
>;
export const StartPomodoroDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "StartPomodoroInput" },
            },
          },
        },
      ],
...
>;
export const PausePomodoroDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "PausePomodoro" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
  ...
  PausePomodoroMutationVariables
>;
export const ResumePomodoroDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "ResumePomodoro" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
  ...
  ResumePomodoroMutationVariables
>;
export const StopPomodoroDocument = {
  ...
  StopPomodoroMutationVariables
>;
export const OnPomodoroEventDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "subscription",
      name: { kind: "Name", value: "OnPomodoroEvent" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "EventReceivedInput" },
            },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "eventReceived" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "input" },
                    ...
                    selections: [
                      {
                        ...
                        typeCondition: {
                          kind: "NamedType",
                          name: { kind: "Name", value: "EventPomodoroPayload" },
                        },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "phaseCount" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "phaseDurationSec" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "remainingTimeSec" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "elapsedTimeSec" },
                            },
                          ],
                        },
                      },
