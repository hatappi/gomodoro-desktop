...
export type CurrentPomodoroQuery = { __typename?: 'Query', currentPomodoro?: { __typename?: 'Pomodoro', id: string, state: PomodoroState, taskId: string, startTime: string, phase: PomodoroPhase, phaseCount: number, remainingTimeSec: number, elapsedTimeSec: number } | null };
...
export type StartPomodoroMutation = { __typename?: 'Mutation', startPomodoro?: { __typename?: 'Pomodoro', id: string, state: PomodoroState, taskId: string, startTime: string, phase: PomodoroPhase, phaseCount: number, remainingTimeSec: number, elapsedTimeSec: number } | null };

export type PausePomodoroMutationVariables = Exact<{ [key: string]: never; }>;


export type PausePomodoroMutation = { __typename?: 'Mutation', pausePomodoro?: { __typename?: 'Pomodoro', id: string, state: PomodoroState, taskId: string, startTime: string, phase: PomodoroPhase, phaseCount: number, remainingTimeSec: number, elapsedTimeSec: number } | null };

export type ResumePomodoroMutationVariables = Exact<{ [key: string]: never; }>;


export type ResumePomodoroMutation = { __typename?: 'Mutation', resumePomodoro?: { __typename?: 'Pomodoro', id: string, state: PomodoroState, taskId: string, startTime: string, phase: PomodoroPhase, phaseCount: number, remainingTimeSec: number, elapsedTimeSec: number } | null };

export type StopPomodoroMutationVariables = Exact<{ [key: string]: never; }>;


export type StopPomodoroMutation = { __typename?: 'Mutation', stopPomodoro?: { __typename?: 'Pomodoro', id: string, state: PomodoroState, taskId: string, startTime: string, phase: PomodoroPhase, phaseCount: number, remainingTimeSec: number, elapsedTimeSec: number } | null };
